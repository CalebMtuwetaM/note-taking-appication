...
print(newnoteapp.find_note_by_ID(note1["note_id"]))
...
#print(newnoteapp.next(2,newnoteapp.notes))
#export all notes to the notes.csv 
#newnoteapp.export_notes("notes.csv")
#import all notes from notes.csv
#newnoteapp.import_notes("notes.csv")
